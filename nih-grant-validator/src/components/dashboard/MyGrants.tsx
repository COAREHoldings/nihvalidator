    ...
    <div className="flex-1 bg-neutral-50 min-h-screen">
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-neutral-900 mb-2">My Grants</h1>
            <p className="text-neutral-500">Manage all your grant applications</p>
          </div>
          <button
            onClick={onStartNew}
            className="flex items-center gap-2 px-5 py-3 bg-primary-500 text-white rounded-xl hover:bg-primary-600 transition-colors shadow-sm"
          >
        ...
        {hasProjects && (
          <div className="grid grid-cols-3 gap-4 mt-6">
            <div className="bg-white rounded-xl border border-neutral-200 p-5">
              <p className="text-sm text-neutral-500 mb-1">Total Grants</p>
