...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["image/png", "image/jpeg", "image/gif", "image/webp", "image/svg+xml"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for figures" ON storage.objects FOR SELECT USING (bucket_id = 'figures');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for figures" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'figures');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for figures" ON storage.objects FOR UPDATE USING (bucket_id = 'figures');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for figures" ON storage.objects FOR DELETE USING (bucket_id = 'figures');`
    ];
